...
// 글을 수정하는 SQL문
// UPDATE topic SET title=post.title, description=post.description, author_id=1 WHERE id=post.id

// 글을 생성하는 기능을 구현할 때 사용했던 insertId는 여기서는 사용되지 않는다.
// 사용했다가 오류가 발생하였는데 INSERT가 아닌 UPDATE에서 사용하니 원하는 값인 0이 나왔기 때문이다.
