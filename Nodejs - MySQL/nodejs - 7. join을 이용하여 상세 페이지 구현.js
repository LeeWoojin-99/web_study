// nodejs - 7. join을 이용하여 상세 페이지 구현

// author테이블의 데이터를 불러와서 상세 페이지를 읽었을 때 글의 저자가 누군지 알 수 있게 하였다.

// SQL문
// SELECT * FROM topic LEFT JOIN author ON topoic.author_id=author.id WHERE topic.id=?
