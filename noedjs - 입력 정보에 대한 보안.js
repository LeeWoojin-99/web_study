...
// "../abc.js"와 같이 디렉터리를 조작할 수 있는 query string이 요청되었을 때
// 이것에서 디렉터리를 조작할 수 있는 부분만을 제거하는 작업을 함으로써 입력 정보에 대한 보안을 강화할 수 있다.
// path module에서 parse()를 하여 객체로 얻어낸 값 중에서 base라는 property를 사용하였다.

// 사용자로부터 query string을 받아서 디렉터리에 접근하는 부분을 모두 수정하였다.
// var filteredId = path.parse("path").base;
// 기존에 queryData.id가 들어가던 부분을 filteredId로 교체

var http = require("http");
var fs = require("fs");
var url = require("url");
var qs = require("querystring");
var template = require("./nodejs - template module (CSS).js");
                ...
                fs.readdir("./nodejs_data", function(err, fileList){
                    ...
                    response.end(template.html(list, title,
                        ...
                        <ul id="controlBtnList">
                            <a href="./create" class="controlBtn">Create</a> <a href="./update?id=${title}" class="controlBtn">Update</a>
